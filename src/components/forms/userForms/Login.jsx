  ...
  return (
    <div className='w-full lg:w-[40%] max-w-md block p-6 rounded shadow-lg shadow-black/20 bg-slate-50 mx-auto'>
      ...
      <form className='mt-10' onSubmit={handleSubmit}>
        ...
        {(isError || isSuccess) && <MessagesContainer msg={msg} isSuccess={isSuccess} isError={isError} />}
        ...
        <p className='text-gray-800 mt-6 text-center'>
          Not a Client?
          <Link to='/register' className='mx-2 text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out'>
            Register
          </Link>
        </p>
      </form>
